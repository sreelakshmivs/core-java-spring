...
public enum CoreSystemService {
	...
	// PoA Onboarding services
    POA_ONBOARDING_WITH_NAME_SERVICE(CommonConstants.CORE_SERVICE_POA_ONBOARDING_WITH_NAME, CommonConstants.POA_ONBOARDING_URI + CommonConstants.OP_POA_ONBOARDING_WITH_NAME),
    POA_ONBOARDING_WITH_CSR_SERVICE(CommonConstants.CORE_SERVICE_POA_ONBOARDING_WITH_CSR, CommonConstants.POA_ONBOARDING_URI + CommonConstants.OP_POA_ONBOARDING_WITH_CSR),
